...
const resolvers = {
  Query: {
    ...
    leaderboards: async () =>
      await models.leaderboard.findAll({ order: [["points", "DESC"]] }),
    leaderboard: async (obj, args) =>
      await models.leaderboard.findByPk(args.id),
  },
  Leaderboard: {
  ...
  User: {
    leaderboard: async (obj, args) =>
      models.leaderboard.findAll({ where: { userId: obj.id } }),
  },
  Mutation: {
